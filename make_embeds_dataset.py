...
class MakeEmbedsDataset(DatasetEditor):
    ...
    def _map(self, batch: dict) -> dict | None:
        ...
        _, _, attention_mask, multimodal_embeds, multimodal_tokens = self.vlac.vlm.prepare_for_multimodal(input_ids, None, attention_mask, input_ids, vision, encode=False)
